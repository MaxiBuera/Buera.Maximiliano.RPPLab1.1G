        ...
        if(getStringLetras("\nIngrese nombre del cliente: ",nombreAux)){
            ...
            if(getStringLetras("\nIngrese apellido del cliente: ",apellidoAux)){
                ...
                if(!getValidInt("\nIngrese DNI: ","\nDNI Incorrecto\n",&dniAux,10000000,99999999,2)){
                    ...
                    arrayClientes[indice].dni = dniAux;
 ...
 *
 */
int cliente_altaForzada(eCliente* arrayClientes,int limite,char* nombre,char* apellido, int dni)
{
    int retorno = -1;
    int i;
    ...
    if(limite > 0 && arrayClientes != NULL)
    {
        ...
        for(i=0;i<limite;i++)
        {
            ...
            if(arrayClientes[i].isEmpty != LIBRE){
                ...
                printf("\n%12d%18s\t\t%s\t\t%d",arrayClientes[i].id,arrayClientes[i].nombre,arrayClientes[i].apellido,arrayClientes[i].dni);
            }
        }
        printf("\n");
    }
        ...
        switch(opc)
        {
            ...
            case 2:
                if(getStringLetras("\nIngrese apellido del cliente: ",apellidoAux)){
                    ...
                    cliente_normalizarCadena(apellidoAux);
                    strcpy(arrayClientes[indice].nombre,apellidoAux);
